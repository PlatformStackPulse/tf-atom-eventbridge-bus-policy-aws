# tf-atom-eventbridge-bus-policy-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-eventbridge-bus-policy-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-eventbridge-bus-policy-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS EventBridge Bus Policy - manages cross-account event bus access.
...
|------|-------------|------|---------|:--------:|
| <a name="input_event_bus_name"></a> [event\_bus\_name](#input\_event\_bus\_name) | Name of the event bus | `string` | n/a | yes |
| <a name="input_policy"></a> [policy](#input\_policy) | JSON policy document for cross-account access | `string` | n/a | yes |
